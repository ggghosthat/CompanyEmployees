    ...
    public partial class InitialData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c9d4c053-49b6-410c-bc78-2d54a9991870"), "Seattle", "USA", "Microsoft" });

            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Company id", "Address", "Country", "Name" },
                values: new object[] { new Guid("3d490a70-94ce-4d15-9494-5248280c2ce3"), "San-Francisco", "USA", "Google" });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Company id", "Age", "CompanyId", "Name", "Position" },
